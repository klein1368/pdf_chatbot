...
app.post("/upload", upload.single("file"), async (req, res) => {
  ...
  try {
    ...
    if (ext.endsWith(".csv")) {
      ...
      fileStore[fileId] = pdfData.text;               // ✅ Store extracted text
      preview = pdfData.text.slice(0, 500);           // ✅ Send preview snippet
      base64 = dataBuffer.toString("base64");         // ✅ For actual rendering
    } else {
